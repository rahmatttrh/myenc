...
<div class="page-inner">
   <div class="page-header d-flex">
      ...
      <h5 class="page-title">Off Employee</h5>
   ...
   <div class="card card-with-nav shadow-none border">
      <div class="card-header d-flex">
         <div class="row row-nav-line">
            <ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
               ...
               <li class="nav-item"> <a class="nav-link show active" id="pills-draft-tab-nobd" data-toggle="pill" href="#pills-draft-nobd" role="tab" aria-controls="pills-draft-nobd" aria-selected="false">Draft</a> </li>
               <li class="nav-item"> <a class="nav-link " id="pills-exit-tab-nobd" data-toggle="pill" href="#pills-exit-nobd" role="tab" aria-controls="pills-exit-nobd" aria-selected="false">Exit</a> </li>
      ...
      <div class="card-body">
         <div class="tab-content" id="pills-without-border-tabContent">
            ...
            <div class="tab-pane fade" id="pills-exit-nobd" role="tabpanel" aria-labelledby="pills-exit-tab-nobd">
               <div class="table-responsive">
